...
class Hamming {	
	...
	void compare(String dna1, String dna2) {
		if(handleErrors(dna1, dna2)) return;
		...
		showResultMessage(dna1, dna2, resultString);
	}
	
	boolean handleErrors(String dna1, String dna2) {
	...
	public static void main(String args[]) {
		...
		dnaComparison.compare(dna1, dna2);
	}
}
